...
class PredictionCameraPreviewPage extends StatelessWidget {
  final String jwt, email;
  final AssetImage fortressAssetImage;
  const PredictionCameraPreviewPage(
  ...
  Widget build(BuildContext context) {
    ...
    final imagesFuture = imageHandler.getPredictedImagesFromServers();
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'People Detected',
